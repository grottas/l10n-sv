  ...
  return (function (e) {
    ...
    function (e, t, n) {
      ...
      function s(e, t) {
        ...
        if (
          ((n = t.header),
          new RegExp("<([A-Za-z][A-Za-z0-9]*)\\b[^>]*>(.*?)</\\1>").test(n))
        )
          r.innerHTML = t.header;
        else {
          var o = document.createElement("h1"),
            i = document.createTextNode(t.header);
          o.appendChild(i),
            o.setAttribute("style", t.headerStyle),
            r.appendChild(o);
        }
                        ...
                        if (e.src && e.src !== window.location.href)
                          return (function (e) {
                            return new Promise(function (t) {
                              (function n() {
                                e &&
                                "undefined" != typeof e.naturalWidth &&
                                0 !== e.naturalWidth &&
                                e.complete
                                  ? t()
                                  : setTimeout(n, 500);
            ...
            (r.responseType = "arraybuffer"),
              ...
              r.addEventListener("load", function () {
                if (-1 === [200, 201].indexOf(r.status))
                  return p(e), void e.onError(r.statusText, r);
                m(e, t, r.response);
              }),
      ...
      var h = function (e, t) {
        var n,
          r =
            "object" === y((n = e.printable)) &&
            n &&
            (n instanceof HTMLElement || 1 === n.nodeType)
              ? e.printable
              : document.getElementById(e.printable);
        r
          ? ((e.printableElement = (function o(e, t) {
              for (
                var n = e.cloneNode(),
                ...
                if (-1 === t.ignoreElements.indexOf(r[i].id)) {
                  var a = o(r[i], t);
                  n.appendChild(a);
                }
              t.scanStyles &&
                ...
                n.setAttribute(
                  ...
                  (function (e, t) {
                    for (
                      var n = "",
                        r = (document.defaultView || window).getComputedStyle(
                          e,
                          ""
                        ),
                        o = 0;
                      ...
                      (-1 !== t.targetStyles.indexOf("*") ||
                        -1 !== t.targetStyle.indexOf(r[o]) ||
                        c(t.targetStyles, r[o])) &&
                        r.getPropertyValue(r[o]) &&
                        (n += r[o] + ":" + r.getPropertyValue(r[o]) + ";");
                    return (
                      n +
                      "max-width: " +
                      t.maxWidth +
        ...
        w = function (e, t) {
          e.printable.constructor !== Array && (e.printable = [e.printable]),
            ...
            e.printable.forEach(function (t) {
              ...
              if (
                (n.setAttribute("style", e.imageStyle),
                (n.src = t),
                o.isFirefox())
              ) {
                var r = n.src;
      ...
      var x = ["pdf", "html", "image", "json", "raw-html"],
        C = function () {
          var e = {
              printable: null,
          ...
          switch (S(t)) {
            ...
            case "object":
              ...
              (e.fallbackPrintable =
                "undefined" != typeof t.fallbackPrintable
                  ? t.fallbackPrintable
                  : e.printable),
              ...
              e))
                "printable" !== n &&
                  "fallbackPrintable" !== n &&
                  (e[n] = "undefined" != typeof t[n] ? t[n] : e[n]);
              break;
            default:
              throw new Error(
          ...
          if (
            ...
            -1 === x.indexOf(e.type.toLowerCase())
          )
            throw new Error(
