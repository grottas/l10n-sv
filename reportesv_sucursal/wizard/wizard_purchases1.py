...
class wizard_sv_purchase_report1(models.TransientModel):
    _name = 'wizard.sv.purchase.report1'
    ...
    def print_purchase_report1(self):
        datas = {'ids': self._ids,
                 'form': self.read()[0],
                 'model': 'wizard.sv.purchase.report1'}
        return self.env.ref('reportesv_sucursal.report_purchase_pdf1').report_action(self, data=datas)
