...
class wizard_sv_purchase_report2(models.TransientModel):
    _name = 'wizard.sv.purchase.report2'
    ...
    def print_purchase_report2(self):
        datas = {'ids': self._ids,
                 'form': self.read()[0],
                 'model': 'wizard.sv.purchase.report2'}
        return self.env.ref('reportesv_sucursal.report_purchase_pdf2').report_action(self, data=datas)
