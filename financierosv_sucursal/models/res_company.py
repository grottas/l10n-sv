...
,(select COALESCE(sum(aml2.debit),0)
        ...
        where aa2.company_id={0} and aa2.code like aa.code||'%' and COALESCE(am1.date,am1.invoice_date)>=CAST('{4}' as date) and COALESCE(am1.date,am1.invoice_date)<=CAST('{5}' as date) and am2.state in ('posted') ) as debe     
,(select COALESCE(sum(aml2.credit),0)
        from account_account aa2
        inner join account_move_line aml2 on aa2.id=aml2.account_id
        inner join account_move am2 on aml2.move_id=am2.id
        where aa2.company_id={0} and aa2.code like aa.code||'%' and COALESCE(am1.date,am1.invoice_date)>=CAST('{4}' as date) and COALESCE(am1.date,am1.invoice_date)<=CAST('{5}' as date) and am2.state in ('posted') ) as haber
...
#**************************************BALANCE GENERAL...!!!************************************************
    def get_general_details(self, company_id, date_year, date_month, acum):
        data = {}
...
order by S2.code
    ...
    def get_general_details1(self, company_id, date_year, date_month, acum):
        data = {}
    ...
    from account_account aa1
        inner join account_move_line aml1 on aa1.id=aml1.account_id
        inner join account_move am1 on aml1.move_id=am1.id
        where aa1.company_id={0}  and aa1.code like aa.code ||'%' and date_part('month',COALESCE(am1.date,am1.invoice_date))<{2} and am1.state in ('posted')) else 0 end as previo1 
,(select COALESCE(sum(aml2.debit),0)
        from account_account aa2
        inner join account_move_line aml2 on aa2.id=aml2.account_id
        inner join account_move am2 on aml2.move_id=am2.id
...
order by S2.code
    ...
    def get_general_details2(self, company_id, date_year, date_month, acum):
        data = {}
...
order by S2.code
    ...
    def get_general_details3(self, company_id, date_year, date_month, acum):
        data = {}
...
order by S2.code
    ...
    def get_general_details4(self, company_id, date_year, date_month, acum):
        data = {}
...
order by S2.code
    ...
    def get_general_details5(self, company_id, date_year, date_month, acum):
        data = {}
...
order by S2.code
    ...
    def get_general_details6(self, company_id, date_year, date_month, acum):
        data = {}
...
order by S2.code
    ...
    def get_general_details7(self, company_id, date_year, date_month, acum):
        data = {}
...
order by S2.code
    ...
    def get_general_details8(self, company_id, date_year, date_month, acum):
        data = {}
...
order by S2.code
    ...
    def get_general_details9(self, company_id, date_year, date_month, acum):
        data = {}
