...
select aa.code 
    ...
    from account_account aa1
        ...
        where aa1.company_id={0}  and aa1.code like aa.code||'%' and date_part('month',COALESCE(am2.date,am2.invoice_date))<={4} and am1.state in ('posted')) else 0 end as previo 
