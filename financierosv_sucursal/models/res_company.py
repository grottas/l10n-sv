...
from cuentas aa 
where aa.company_id= {0} and length(trim(aa.code))=4 and aa.code like '4102%'
order by aa.code
)S2
...
from cuentas aa 
where aa.company_id= {0} and length(trim(aa.code))=4 and aa.code between '1201%' and  '1105%'
order by aa.code
...
from cuentas aa 
where aa.company_id= {0} and length(trim(aa.code))=4 and aa.code between '2101%' and  '2108%'
order by aa.code
